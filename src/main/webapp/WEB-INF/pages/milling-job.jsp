...
<head>
    ...
    <script>
        ...
        function sendStop() {
            var parametersObj = {deviceId: "${deviceId}", operationId: "stop", parameters: []};
            var requestBody = JSON.stringify(parametersObj);
            $.ajax({
                type: 'POST',
                url: "${postUrl}",
...
<div class="flex-container">
    <header>
        <h1>CPMC Milling Operations</h1>
        <h5>Performed by an X-Carve CNC Machine</h5>
    </header>

    <article class="article" id="article">
        <img src="<c:url value="/resources/images/xc-750.png"/>">
    </article>
