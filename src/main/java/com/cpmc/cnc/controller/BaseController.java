package com.cpmc.cnc.controller;

import com.cpmc.cnc.models.DeviceOperation;
import com.cpmc.cnc.models.Operations;
...
public class BaseController {
    ...
    @RequestMapping(value = "/milling-job", method = RequestMethod.GET)
    public String getDeviceParametersPage(@RequestParam("operationId") String operationId, ModelMap model) {
        String probeUrl = "http://uaf132854.ddns.uark.edu:9002/virtualization-uark/probe?deviceId=CNC";
//        String probeUrl = "http://localhost:9002/virtualization-uark/probe?deviceId=CNC";
        ...
        try {
            ...
            model.addAttribute("deviceId", "CNC");
...
//        model.addAttribute("postUrl", "http://uaf132854.ddns.uark.edu:8100/app-ultimaker/operate-device");
        model.addAttribute("postUrl", "http://localhost:8400/cpmc-cnc/operate-device");
        return "milling-job";
    }
